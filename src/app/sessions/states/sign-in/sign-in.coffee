...
.controller("SignInCtrl", ($scope, $state, $stateParams, configurationService, usernameCookie, $timeout, $http, $modal, currentUser, auth, api, alertService, localStorageService, redirectService, rememberDoubtfireCredentialsCookie, doubtfireLoginTimeCookie, AboutDoubtfireModal) ->
