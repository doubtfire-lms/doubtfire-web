...
#     task: '='
#     singleDropZone: '=?'
#   controller: ($scope, $modal, $state, $sce, $timeout, CommentResourceService, taskService, alertService, analyticsService) ->
...
#         (success) ->
#           $scope.comment.text = ""
#           analyticsService.event "Vie Comments", "Added new comment"
#           taskService.scrollDown()
