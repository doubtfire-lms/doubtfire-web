...
import { AchievementBoxPlotComponent } from './visualisations/achievement-box-plot/achievement-box-plot.component';
...
DoubtfireAngularJSModule.directive(
  'achievementBoxPlot',
  downgradeComponent({ component: AchievementBoxPlotComponent })
);
