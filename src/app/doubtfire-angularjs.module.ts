...
import {TaskOverseerViewComponent} from './projects/states/dashboard/directives/task-dashboard/directives/task-overseer-view/task-overseer-view.component';
...
DoubtfireAngularJSModule.directive(
  'fTaskOverseerView',
  downgradeComponent({component: TaskOverseerViewComponent}),
);
