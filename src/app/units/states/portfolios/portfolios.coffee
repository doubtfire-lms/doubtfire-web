...
.controller("UnitPortfoliosStateCtrl", ($scope, Unit, analyticsService, gradeService, projectService, Visualisation, newTaskService, fileDownloaderService, newUserService) ->
