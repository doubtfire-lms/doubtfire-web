      ...
      nv.models.iloBullet = ->
        chart = (selection) ->
          selection.each (d, i) ->
            ...
            g = wrap.select('g')
            gEnter.append('rect').attr('class', 'nv-range nv-rangeHD').style('fill-opacity', '0.6').style('fill', gradeService.gradeColors.HD)
            gEnter.append('rect').attr('class', 'nv-range nv-rangeD' ).style('fill-opacity', '0.6').style('fill', gradeService.gradeColors.D)
            gEnter.append('rect').attr('class', 'nv-range nv-rangeC' ).style('fill-opacity', '0.6').style('fill', gradeService.gradeColors.C)
            gEnter.append('rect').attr('class', 'nv-range nv-rangeP' ).style('fill-opacity', '0.6').style('fill', gradeService.gradeColors.P)
