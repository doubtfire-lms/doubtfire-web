 ...
 * @desc This is a base class to be used with the ng-charts library. It is used to set the root view container for the tooltip service, to avoid issues with the tooltip not displaying correctly.
 *
