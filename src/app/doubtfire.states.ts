...
const NumbastestState: NgHybridStateDeclaration = {
  name: 'numbas_test',
  url: '/numbas_test',
  views: {
    main: {
      component: NumbasComponent,
    },
  },
  data: {
    pageTitle: 'Numbas Test',
    roleWhitelist: ['Student', 'Tutor', 'Convenor', 'Admin'],
  },
};
/**
...
export const doubtfireStates = [institutionSettingsState, HomeState, WelcomeState, SignInState, EditProfileState, NumbastestState];
