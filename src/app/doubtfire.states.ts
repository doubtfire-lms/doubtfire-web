...
// For not found
const NotFoundState: NgHybridStateDeclaration = {
  name: 'not-found',
  url: '/not-found', // You get here with this url
  views: {
    // These are the 2 views - the header and main from the body of DF
    header: {
      // Header is still angularjs
 ...
 */
export const doubtfireStates = [institutionSettingsState, HomeState, NotFoundState];
