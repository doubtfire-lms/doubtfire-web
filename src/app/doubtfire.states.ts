...
const IotrackQrCodeLoginState: NgHybridStateDeclaration = {
  name: 'iotrack-qrcode-login', // This is the name of the state to jump to - so ui-sref="institutionsettings" to jump here
  url: '/iotrack/seat?{room}&{seat}', // You get here with this url
  views: {
    // These are the 2 views - the header and main from the body of DF
 ...
 */
export const doubtfireStates = [institutionSettingsState, IotrackQrCodeLoginState];
