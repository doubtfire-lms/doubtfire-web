...
/**
 * Define the campuses state - used to edit campus data.
 */
const campusesState: NgHybridStateDeclaration = {
  name: 'campuses',         // This is the name of the state to jump to - so ui-sref="campuses" to jump here
  url: '/admin/campuses',   // You get here with this url
 ...
 */
export const doubtfireStates = [campusesState];
